...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Вопросы по аналитике ERP АСУП","2. Вопросы по отражению операций","3. ОПИСАНИЕ ОПЕРАЦИЙ","4. ТЕРМИНЫ И СОКРАЩЕНИЯ","5. ПОДГОТОВКА К РАБОТЕ","6. РЕКОМЕНДАЦИИ ПО ОСВОЕНИЮ","1.1. Статьи бюджета","1.2. Функциональные блоки и разделы учета","Отчеты","2.1. Как отразить состояние обработки Заявки?","2.2. Как отразить состояние обработки ЭО?","2.3. Как отразить операцию в новой системе?","2.4. Как связать объект ERP с документом ДО?","2.5. Как отменить связь объекта ERP с документом ДО?","3.1. Описание БП обработки Заявок на планируемый период","3.2. Инструкции по сопровождению","5.1. Порядок проверки работоспособности","5.2. Порядок загрузки данных и программ","1.1.1. Как указать статью бюджета в заказе клиента?","АСУП Функциональные блоки: Состав","АСУП Разделы учета: Состав","ERP: Функциональные блоки","ERP: Разделы учета","Каким отчетом проверить количество и качество сделок на разработку?","Как сформировать отчет по заказам клиентов в разрезе видов сделок Сопровождение/Разработка?","Как посмотреть исполнение заказов клиентов?","Как посмотреть график отпусков команды?","2.1.1. ДО: отражение состояния обработки Заявки","2.1.2. ERP: отражение состояния обработки Заявки","2.2.1. ДО: отражение состояния обработки ЭО","БП реализации Заявки","РЕГУЛЯРНЫЕ ЗАДАЧИ БП","Практическое руководство пользователя по планированию и производству текущих работ по Сопровождению","Ввод данных по сопровождению","Ввод данных по разработке","Термины и определения","Планирование работ по Сопровождению в ЕРП","Глоссарий","Список сокращений"],
    DREX_NODE_LINKS: ["index.htm","voprosy_po_analitike_erp_asup.htm","voprosy_po_otrazheniyu_operatsij.htm","opisanie_operatsij.htm","terminy_i_sokrashcheniya.htm","podgotovka_k_rabote.htm","rekomendatsii_po_osvoeniyu.htm","stati_byudzheta.htm","funktsionalnye_bloki_i_razdely_ucheta.htm","otchety.htm","kak_otrazit_sostoyanie_obrabotki_zayavki_.htm","kak_otrazit_sostoyanie_obrabotki_eho_.htm","kak_otrazit_operatsiyu_v_novoj_sisteme_.htm","kak_svyazat_obekt_erp_s_dokumentom_do_.htm","kak_otmenit_svyaz_obekta_erp_s_dokumentom_do_.htm","opisanie_bp_obrabotki_zayavok_na_planiruemyj_period.htm","instruktsii_po_soprovozhdeniyu.htm","poryadok_proverki_rabotosposobnosti.htm","poryadok_zagruzki_dannykh_i_programm.htm","kak_ukazat_statyu_byudzheta_v_zakaze_klienta_.htm","asup_funktsionalnye_bloki__sostav.htm","asup_razdely_ucheta__sostav.htm","erp__funktsionalnye_bloki.htm","erp__razdely_ucheta.htm","kakim_otchetom_proverit_kolichestvo_i_kachestvo_sdelok_na_razrabotku_.htm","kak_sformirovat_otchet_po_zakazam_klientov_v_razreze_vidov_sdelok_soprovozhdenie_razrabotka_.htm","kak_posmotret_ispolnenie_zakazov_klientov_.htm","kak_posmotret_grafik_otpuskov_komandy_.htm","do__otrazhenie_sostoyaniya_obrabotki_zayavki.htm","erp__otrazhenie_sostoyaniya_obrabotki_zayavki.htm","do__otrazhenie_sostoyaniya_obrabotki_eho.htm","bp_realizatsii_zayavki.htm","regulyarnye_zadachi_bp.htm","prakticheskoe_rukovodstvo_polzovatelya_po_planirovaniyu_i_proizvodstvu_tekushchikh_rabot_po_soprovozhdeniyu.htm","vvod_dannykh_po_soprovozhdeniyu.htm","vvod_dannykh_po_razrabotke.htm","terminy_i_opredeleniya.htm","planirovanie_rabot_po_soprovozhdeniyu_v_erp.htm","glossarij.htm","spisok_sokrashchenij.htm"],
    DREX_NODE_CHILD_START: [1,7,10,15,17,17,19,19,20,24,28,30,31,31,31,31,33,34,34,34,34,34,34,34,34,34,36,36,36,36,36,36,36,36,38,38,38,40,40,40],
    DREX_NODE_CHILD_END: [7,10,15,17,17,19,19,20,24,28,30,31,31,31,31,33,34,34,34,34,34,34,34,34,34,36,36,36,36,36,36,36,36,38,38,38,40,40,40,40],
    DREX_MENU_TYPE: 2,
