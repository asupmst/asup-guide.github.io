...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Вопросы по аналитике ERP АСУП","2. Вопросы по отражению операций","3. ОПИСАНИЕ ОПЕРАЦИЙ","4. ТЕРМИНЫ И СОКРАЩЕНИЯ","5. ПОДГОТОВКА К РАБОТЕ","6. РЕКОМЕНДАЦИИ ПО ОСВОЕНИЮ","1.1. Как сформировать отчет по заказам клиентов в разрезе видов сделок Сопровождение/Разработка","1.2. Как указать статью бюджета в заказе клиента?","1.3. Состав статей бюджета","2.1. Как отразить операцию в новой системе?","2.2. Описание БП обработки Заявок на планируемый период","5.1. Порядок проверки работоспособности","5.2. Порядок загрузки данных и программ","Ввод данных по сопровождению","Ввод данных по разработке","БП реализации Заявки","РЕГУЛЯРНЫЕ ЗАДАЧИ БП"],
    DREX_NODE_LINKS: ["index.htm","voprosy_po_analitike_erp_asup.htm","voprosy_po_otrazheniyu_operatsij.htm","opisanie_operatsij.htm","terminy_i_sokrashcheniya.htm","podgotovka_k_rabote.htm","rekomendatsii_po_osvoeniyu.htm","kak_sformirovat_otchet_po_zakazam_klientov_v_razreze_vidov_sdelok_soprovozhdenie_razrabotka.htm","kak_ukazat_statyu_byudzheta_v_zakaze_klienta_.htm","sostav_statej_byudzheta.htm","kak_otrazit_operatsiyu_v_novoj_sisteme_.htm","opisanie_bp_obrabotki_zayavok_na_planiruemyj_period.htm","poryadok_proverki_rabotosposobnosti.htm","poryadok_zagruzki_dannykh_i_programm.htm","vvod_dannykh_po_soprovozhdeniyu.htm","vvod_dannykh_po_razrabotke.htm","bp_realizatsii_zayavki.htm","regulyarnye_zadachi_bp.htm"],
    DREX_NODE_CHILD_START: [1,7,10,12,12,12,14,14,16,16,16,16,18,18,18,18,18,18],
    DREX_NODE_CHILD_END: [7,10,12,12,12,14,14,16,16,16,16,18,18,18,18,18,18,18],
    DREX_MENU_TYPE: 2,
