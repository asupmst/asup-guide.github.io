...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","Аннотация","Содержание","1. ВВЕДЕНИЕ","2. НАЗНАЧЕНИЕ И УСЛОВИЯ ПРИМЕНЕНИЯ","3. ПОДГОТОВКА К РАБОТЕ","4. ОПИСАНИЕ ОПЕРАЦИЙ","5. АВАРИЙНЫЕ СИТУАЦИИ","6. РЕКОМЕНДАЦИИ ПО ОСВОЕНИЮ","7. ТЕРМИНЫ И СОКРАЩЕНИЯ","Лист регистрации изменений","1.1. Область применения","1.2. Краткое описание возможностей","1.3. Уровень подготовки пользователя","1.4. Перечень эксплуатационной документации","3.1. Состав и содержание дистрибутивного носителя данных","3.2. Порядок загрузки данных и программ","3.3. Порядок проверки работоспособности","4.1. Как отразить операцию в новой системе?","4.2. Разработка руководства пользователя","4.2.1. Порядок публикации проектов документов для совместной разработки на tiwri","4.2.2. Порядок хранения разработанной документации в ДО / web","4.2.3. Порядок согласования разработанной документации","4.2.4. Порядок экспорта согласованной документации в HTML/PDF"],
    DREX_NODE_LINKS: ["index.htm","annotatsiya.htm","soderzhanie.htm","vvedenie.htm","naznachenie_i_usloviya_primeneniya.htm","podgotovka_k_rabote.htm","opisanie_operatsij.htm","avarijnye_situatsii.htm","rekomendatsii_po_osvoeniyu.htm","terminy_i_sokrashcheniya.htm","list_registratsii_izmenenij.htm","oblast_primeneniya.htm","kratkoe_opisanie_vozmozhnostej.htm","uroven_podgotovki_polzovatelya.htm","perechen_ehkspluatatsionnoj_dokumentatsii.htm","sostav_i_soderzhanie_distributivnogo_nositelya_dannykh.htm","poryadok_zagruzki_dannykh_i_programm.htm","poryadok_proverki_rabotosposobnosti.htm","kak_otrazit_operatsiyu_v_novoj_sisteme_.htm","razrabotka_rukovodstva_polzovatelya.htm","poryadok_publikatsii_proektov_dokumentov_dlya_sovmestnoj_razrabotki_na_tiwri.htm","poryadok_khraneniya_razrabotannoj_dokumentatsii_v_do___web.htm","poryadok_soglasovaniya_razrabotannoj_dokumentatsii.htm","poryadok_ehksporta_soglasovannoj_dokumentatsii_v_html_pdf.htm"],
    DREX_NODE_CHILD_START: [1,11,11,11,15,15,18,20,20,20,20,20,20,20,20,20,20,20,20,20,24,24,24,24],
    DREX_NODE_CHILD_END: [11,11,11,15,15,18,20,20,20,20,20,20,20,20,20,20,20,20,20,24,24,24,24,24],
    DREX_MENU_TYPE: 2,
