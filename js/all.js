...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Вопросы по аналитике ERP АСУП","2. Вопросы по отражению операций","3. ОПИСАНИЕ ОПЕРАЦИЙ","4. ТЕРМИНЫ И СОКРАЩЕНИЯ","5. ПОДГОТОВКА К РАБОТЕ","6. РЕКОМЕНДАЦИИ ПО ОСВОЕНИЮ","1.1. Как сформировать отчет по заказам клиентов в разрезе видов сделок Сопровождение/Разработка","Как посмотреть исполнение заказов клиентов","1.2. Каким отчетом проверить количество и качество сделок на разработку?","1.3. Как указать статью бюджета в заказе клиента?","1.4. Состав статей бюджета","2.1. Как отразить состояние обработки ЭО","2.2. Как отразить состояние обработки Заявки","2.3. Как отразить операцию в новой системе?","3.1. Описание БП обработки Заявок на планируемый период","Инструкции по сопровождению","5.1. Порядок проверки работоспособности","5.2. Порядок загрузки данных и программ","Ввод данных по сопровождению","Ввод данных по разработке","2.1.1. ДО: отражение состояния обработки ЭО","2.2.1. ДО: отражение состояние обработки Заявки","БП реализации Заявки","РЕГУЛЯРНЫЕ ЗАДАЧИ БП","Практическое руководство пользователя по планированию и производству текущих работ по Сопровождению","Термины и определения","Планирование работ по Сопровождению в ЕРП","Глоссарий","Список сокращений"],
    DREX_NODE_LINKS: ["index.htm","voprosy_po_analitike_erp_asup.htm","voprosy_po_otrazheniyu_operatsij.htm","opisanie_operatsij.htm","terminy_i_sokrashcheniya.htm","podgotovka_k_rabote.htm","rekomendatsii_po_osvoeniyu.htm","kak_sformirovat_otchet_po_zakazam_klientov_v_razreze_vidov_sdelok_soprovozhdenie_razrabotka.htm","kak_posmotret_ispolnenie_zakazov_klientov.htm","kakim_otchetom_proverit_kolichestvo_i_kachestvo_sdelok_na_razrabotku_.htm","kak_ukazat_statyu_byudzheta_v_zakaze_klienta_.htm","sostav_statej_byudzheta.htm","kak_otrazit_sostoyanie_obrabotki_eho.htm","kak_otrazit_sostoyanie_obrabotki_zayavki.htm","kak_otrazit_operatsiyu_v_novoj_sisteme_.htm","opisanie_bp_obrabotki_zayavok_na_planiruemyj_period.htm","instruktsii_po_soprovozhdeniyu.htm","poryadok_proverki_rabotosposobnosti.htm","poryadok_zagruzki_dannykh_i_programm.htm","vvod_dannykh_po_soprovozhdeniyu.htm","vvod_dannykh_po_razrabotke.htm","do__otrazhenie_sostoyaniya_obrabotki_eho.htm","do__otrazhenie_sostoyanie_obrabotki_zayavki.htm","bp_realizatsii_zayavki.htm","regulyarnye_zadachi_bp.htm","prakticheskoe_rukovodstvo_polzovatelya_po_planirovaniyu_i_proizvodstvu_tekushchikh_rabot_po_soprovozhdeniyu.htm","terminy_i_opredeleniya.htm","planirovanie_rabot_po_soprovozhdeniyu_v_erp.htm","glossarij.htm","spisok_sokrashchenij.htm"],
    DREX_NODE_CHILD_START: [1,7,12,15,17,17,19,19,21,21,21,21,21,22,23,23,25,26,26,26,26,26,26,26,26,26,28,30,30,30],
    DREX_NODE_CHILD_END: [7,12,15,17,17,19,19,21,21,21,21,21,22,23,23,25,26,26,26,26,26,26,26,26,26,28,30,30,30,30],
    DREX_MENU_TYPE: 2,
